let Counter1 = React.createClass({
    ...
    componentWillMount: function() {
        console.log('Metoda wywolywana przed wyrenderowaniem elementu. Mozna zmienic stan elementu bez przerenderowywania go.');
    },
    ...
    shouldComponentUpdate: function (nextProps, nextState) {
        console.log('Sprawdza czy konieczne jest przerenderowannie elementu. Pozwala zoptymalizowac aplikacje poprzez unikanie niepotrzebnych operacji');
    ...
    render: function() {
        return React.createElement('div', {},
                React.createElement('button', {onClick: this.increment}, 'Dodaj 1 do licznika.'),
                React.createElement('button', {onClick: this.decrement}, 'Odejmij 1 od licznika.'),
                React.createElement('span', {}, 'Licznik 1: ' + this.state.counter)
        );
    },

    componentWillUnmount: function () {
        console.log('Metoda wywolywana zaraz przed usunieciem elementu. Pozwala pozbyc sie listenerow itp pozostalych po obiekcie.')
    }
}),
